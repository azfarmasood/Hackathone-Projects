...
const GalleryData: FC<PublicIDProps> = ({ imagedata, onUnheart,path }) => {
          ...
          <div>
            <FavouritesSvg
              ...
              onClick={() => {
                ...
                setTransition(() => {
                  FavouriteApiServer(imagedata.public_id, false,path);
                });
              }}
            />
          </div>
          ...
          <div>
            <FavouritesSvg
              ...
              onClick={() => {
                ...
                setisFavourite(true);
                setTransition(() => {
                  FavouriteApiServer(imagedata.public_id, true,path);
                });
              }}
            />
          </div>
